...
For various reasons the scenario may need manual editing in Scenario Editor to work properly after the stock is swapped. For example, slightly different physics may change the timing and position of AI at critical points and new signalling bugs may manifest themselves.
