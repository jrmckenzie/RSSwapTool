...
RSSwapTool is currently in pre-release status and may have various bugs that need to be fixed. It may not even work at all. Before using this tool you must accept the terms of the license enclosed within. See also https://www.gnu.org/licenses/gpl-3.0.html.
...
Locate your scenario.bin file by pressing the "Select scenario file to process" button. Then choose which of the tool's pre-configured swaps you wish to perform on your scenario, by ticking the appropriate box. You can select as many, or as few, as you like. The more you select, the longer it will take. In most cases a scenario should take no more than 20 seconds to process, possibly much less.

The program will save a back-up of the original scenario in a file named after the original file, with the date and time of the substitution operation appended.
...
* Replace Class 37s - Replace BR Blue Pack Class 37s with AP equivalent
...
* Replace Class 101 sets - Tick to enable replacing of retired RSC Class101Pack with RSC BritishRailClass101 sets
...
There is also a "Settings" button you can press to update some settings (e.g. location of RailWorks folder, substitution behaviour with Class 56 and 86).
